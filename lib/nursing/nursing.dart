...
export 'presentation/pages/resident_directory_page.dart';
export 'presentation/pages/create_resident_page.dart';
export 'presentation/pages/resident_detail_page.dart';
export 'presentation/widgets/resident_summary_widget.dart';
